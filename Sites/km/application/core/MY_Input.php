...
class MY_Input extends CI_Input {
	...
	*/
	...
	{
		// Check if not set $xss_clean value
		if($xss_clean === FALSE AND $this->_enable_xss === TRUE)
		{
			$xss_clean = FALSE;
		}
		else if($xss_clean === FALSE AND $this->_enable_xss === FALSE)
		{
			$xss_clean = FALSE;
		}
		else if($xss_clean === TRUE AND $this->_enable_xss === FALSE)
		{
			$xss_clean = TRUE;
		}
		else

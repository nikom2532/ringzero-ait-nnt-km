	...
	?>      
    							<tbody>
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                        <?php echo anchor("backoffice/contact_us/delete/".$row->CONT_id,"<img src='".site_url('asset/backoffice/images/icons/delete.png')."'/>",array('onclick' => 'return delete_data()')); ?></td>
                                    </tr>
      <?php 
						endforeach; 
				 }else{

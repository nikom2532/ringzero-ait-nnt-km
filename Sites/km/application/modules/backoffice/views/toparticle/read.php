...
<div class="content-box-content"> 
	<form action="<?php echo site_url('backoffice/toparticle/update'); ?>" method="post" enctype="multipart/form-data">
	...
	<fieldset>
    	<table width="100%" cellpadding="1" cellspacing="1" style="border:1px solid #666">
            ...
            <tr>
                ...
                <td width="75%"><?php echo $result->CAT_topic; ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="75%">
                    ...
                    ?>
                    <?php echo ( $result->ATC_activated == 1  ? 'เปิด' : 'ปิด'); ?> 
                </td>
            </tr>
            <tr>
            	<td><b>แนะนำบทความ</b></td>
                <td>
                          <?php 
                                        $data = array(
                                                'name' => 'ATC_comment',
                                                'id' => 'ATC_comment',
                                                'value' =>  (empty($result) ? set_value('ATC_comment') : set_value('ATC_comment',htmldecode($result->ATC_comment))),
                                                'rows'   => '5',
                                                 'cols'        => '100'
                                            );

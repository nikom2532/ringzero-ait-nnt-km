...
/**
 * MY_Cart Edited Product name rules for Thai charecter.
 *
 * An open source application development framework for PHP 5.1.6 or newer
 *
 * @package		CodeIgniter, MY_Cart
 * @author		Supachai Komepiraprai
 * @copyright	Copyright (c) 2011, Supachai Komepiraprai.
 * @since			Version 1.0
 * @filesource	MY_Cart.php
...
class MY_Cart extends CI_Cart {
	...
	var $product_name_rules	= '\.\:\-_ a-z0-9ก-๙เแ'; // alpha-numeric, dashes, underscores, colons or periods, Thai charecter

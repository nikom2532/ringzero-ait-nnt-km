...
$db['articledb']['db_debug'] = TRUE;
$db['articledb']['cache_on'] = FALSE;
$db['articledb']['cachedir'] = '';
$db['articledb']['char_set'] = 'utf8';
$db['articledb']['dbcollat'] = 'utf8_general_ci';
$db['articledb']['swap_pre'] = '';
$db['articledb']['autoinit'] = TRUE;
$db['articledb']['stricton'] = FALSE;
